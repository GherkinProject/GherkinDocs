...
/begin{itemize}
/item
On crée un dictionnaire de nom markov, tel que markov[i][j] renvoie la probabilité de passage de i à j.
/item
On pondère ces probabilités par un nombre dépendant uniquement de i. Ce choix implique qu'on considère qu'à un temps très élevé, on a théoriquement convergence vers la playlist idéale pour l'utilisateur.
/item
Selon certains critères, on décide d'incrémenter ou de décrémenter la probabilité, en gardant le caractère stochastique de markov.
/item
